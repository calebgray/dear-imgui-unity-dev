...
void ShowStyleEditor(bool* show = nullptr)
{
    ...
    ImGui::Spring(0);
    ImGui::RadioButton("HSV", &edit_mode, ImGuiColorEditFlags_DisplayRGB);
    ImGui::Spring(0);
    ImGui::RadioButton("HEX", &edit_mode, ImGuiColorEditFlags_DisplayRGB);
    ImGui::EndHorizontal();
...
void ShowLeftPane(float paneWidth)
{
    ...
    int saveIconWidth     = 0; // Application_GetTextureWidth(s_SaveIcon);
    int saveIconHeight    = 0; // Application_GetTextureWidth(s_SaveIcon);
    int restoreIconWidth  = 0; // Application_GetTextureWidth(s_RestoreIcon);
    int restoreIconHeight = 0; // Application_GetTextureWidth(s_RestoreIcon);
